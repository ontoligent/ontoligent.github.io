...
historically.[^ds-from-1963-to-2012-2] The primary method employed is
...
question.[^ds-from-1963-to-2012-3]

[^ds-from-1963-to-2012-2]: A collocation is a combination of two or more
    words that function as a single semantic unit. In contrast to a mere
    n-gram, their usage tends to be idiomatic and non-random.
    Etymologically, their usage often begins as marked constructions, by
    means of quotes and hyphens, before eventually becoming idiomatic.
    Often, a collocation become so common that it becomes a single word.
    For example, the word "database" began as "data base" and
    "data-base" before evolving into its current form. Throughout this
    essay, the collocation "data science" is referred to as a term or
    phrase, reflecting its unitary semantic status.

[^ds-from-1963-to-2012-3]: The arguments and observations made by the
...
priors on the way to estimating posteriors.[^ds-from-1963-to-2012-4]
:::

[^ds-from-1963-to-2012-4]: This is more than an analogy. If we think of
...
(AFCRL).[^ds-from-1963-to-2012-5] These reports do not provide an
...
[^ds-from-1963-to-2012-5]: The DSL was formed by combining the Computer
...
> [@corliss1967: 157].[^ds-from-1963-to-2012-6]

[^ds-from-1963-to-2012-6]: Preceding the usage of data deluge and in a
...
Doolittle,[^ds-from-1963-to-2012-7] the last chairman of NACA before it
became NASA:

[^ds-from-1963-to-2012-7]: This is the very same General Doolittle of
    Doolittle's Raid.
...
[@office1979].[^ds-from-1963-to-2012-8]

[^ds-from-1963-to-2012-8]: This continues into the 1980s, with Gateway
...
*data is machine readable information*.[^ds-from-1963-to-2012-9] It
...
[^ds-from-1963-to-2012-9]: Preceding the usage of data deluge and in a
    wider context is "information explosion." Both expressions conjure
    images of disaster and have been remarkably persistent up to the
...
time.[^ds-from-1963-to-2012-10]

[^ds-from-1963-to-2012-10]: a" have they been displaced by a more
    positive term.
...
1970,[^ds-from-1963-to-2012-11] the term continued to be used, most
...
[^ds-from-1963-to-2012-11]: Altshuler writes that the lab was
...
[@parzen2013], after the term became popular.[^ds-from-1963-to-2012-12]
...
[^ds-from-1963-to-2012-12]: Parzen's use of the term "culture" here
...
@ohsumi1994].[^ds-from-1963-to-2012-13] In these essays, Ohsumi
...
[^ds-from-1963-to-2012-13]: According to Ohsumi, "the term 'data
...
silent bird's fate (332).[^ds-from-1963-to-2012-14] Amplifying Hayashi,
...
[^ds-from-1963-to-2012-14]: The specific reference is to a poem, later
...
> "data specialist" [@higgins1999].[^ds-from-1963-to-2012-15]

[^ds-from-1963-to-2012-15]: Higgins here referred to a quote from
...
> 163].[^ds-from-1963-to-2012-16]

[^ds-from-1963-to-2012-16]: Based on the affiliations cited in his three
...
magnitude.[^ds-from-1963-to-2012-17] This context was the social media
...
Patil 2012).[^ds-from-1963-to-2012-18] Although on its face this claim
is obviously false, it is apparently correct in having identified the
first usages of the term in this new context.

[^ds-from-1963-to-2012-17]: According to the Google Books NGram Viewer,
...
[^ds-from-1963-to-2012-18]: The title of this article was adapted from a
...
Hammerbacher).[^ds-from-1963-to-2012-19] In essence, then, the new role
...
[^ds-from-1963-to-2012-19]: By "simple," the authors meant few
...
Hammerbacher, Yau, Conway, Mason, and Wiggins.[^ds-from-1963-to-2012-20]
...
[^ds-from-1963-to-2012-20]: The influence of O'Reilly on this history is
    worth its own essay.
...
mathematically sound framework.[^ds-from-1963-to-2012-21]

[^ds-from-1963-to-2012-21]: The works of Hastie, Tibshirini, and their
...
"two cultures" in the work of statistics.[^ds-from-1963-to-2012-22]
...
[^ds-from-1963-to-2012-22]: It is no coincidence that Breiman's essay
